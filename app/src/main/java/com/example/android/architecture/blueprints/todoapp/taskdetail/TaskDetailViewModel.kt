...
class TaskDetailViewModel(private val tasksRepository: TasksRepository) : ViewModel() {
    ...
    class TasksViewModelFactory(private val taskRepository: TasksRepository) :
        ViewModelProvider.NewInstanceFactory()
    {
        override fun <T : ViewModel> create(modelClass: Class<T>) = (TaskDetailViewModel(taskRepository) as T)
    }
}
